...
from KGMusic.modules.play import generate_cover
from KGMusic.modules.play import arq
from KGMusic.modules.play import cb_admin_check
from KGMusic.modules.play import transcode
from KGMusic.modules.play import convert_seconds
from KGMusic.modules.play import time_to_seconds
from KGMusic.modules.play import changeImageSize
from KGMusic.config import BOT_NAME as bn
from KGMusic.config import DURATION_LIMIT
from KGMusic.config import UPDATES_CHANNEL as updateschannel
from KGMusic.config import que
from KGMusic.function.admins import admins as a
from KGMusic.helpers.errors import DurationLimitError
from KGMusic.helpers.decorators import errors
from KGMusic.helpers.admins import get_administrators
from KGMusic.helpers.channelmusic import get_chat_id
from KGMusic.helpers.decorators import authorized_users_only
from KGMusic.helpers.filters import command
from KGMusic.helpers.filters import other_filters
from KGMusic.helpers.gets import get_file_name
from KGMusic.services.callsmusic import callsmusic
from KGMusic.services.callsmusic import client as USER
from KGMusic.services.converter.converter import convert
from KGMusic.services.downloaders import youtube
from KGMusic.services.queues import queues
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    ...
                    await lel.edit(
                        f"<b>🔴 Flood Wait Error 🔴 \nUser {user.first_name} couldn't join your channel due to heavy requests for userbot! Make sure user is not banned in group."
                        "\n\nOr manually add @KGAssistant to your Group and try again</b>",
                    )
    try:
        await USER.get_chat(chid)
        # lmoa = await client.get_chat_member(chid,wew)

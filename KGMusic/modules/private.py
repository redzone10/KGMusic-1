...
from KGMusic.config import SOURCE_CODE
from KGMusic.config import ASSISTANT_NAME
from KGMusic.config import PROJECT_NAME
from KGMusic.config import SUPPORT_GROUP
from KGMusic.config import UPDATES_CHANNEL
from KGMusic.config import BOT_USERNAME
from KGMusic.config import OWNER
...
# Tapi Jangan di Hapus Thanks To nya Yaaa :D
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "ᴄʜᴀɴɴᴇʟ ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/{UPDATES_CHANNEL}"), 
                    InlineKeyboardButton(
                        "ɢʀᴏᴜᴘ sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/{SUPPORT_GROUP}")
                ],[
                    InlineKeyboardButton(
...
def map(pos):
    if (pos==1):
        ...
        return [
            ...
            [
                InlineKeyboardButton(
                    text='ᴄʜᴀɴɴᴇʟ ᴜᴘᴅᴀᴛᴇs',
                    url=f"https://t.me/{UPDATES_CHANNEL}",
                ),
                InlineKeyboardButton(
                    text='ɢʀᴏᴜᴘ sᴜᴘᴘᴏʀᴛ', url=f"https://t.me/{SUPPORT_GROUP}"
                ),
            ],
            [
                InlineKeyboardButton(
                    text='🛠 sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ 🛠', url=f"https://{SOURCE_CODE}"
                )
            ],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "📜 ᴄᴀʀᴀ ᴍᴇɴɢɢᴜɴᴀᴋᴀɴ ʙᴏᴛ 📜", url=f"https://t.me/{BOT_USERNAME}?start"
                    )
                ]
            ]
        ),
